    ...
    return (
        <footer id="footer">
                ...
                <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    <div className="md:flex md:justify-between">
                        <div className="mb-6 md:mb-0">
                            <a href="#" className="flex items-center">
                                <img src="https://flowbite.com/docs/images/logo.svg" className="h-8 mr-3"
                                     alt="FlowBite Logo"/>
                                <span
                                    className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Movies</span>
                            </a>
                        </div>
                        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                            ...
                            <div className="mx-4">
                                <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Actors</h2>
                                <ul className="text-gray-600 dark:text-gray-400 font-medium">
                                    <li className="mb-4">
                                        <NavLink to={"/now-playing"} className="hover:underline">Now Playing</NavLink>
                                    </li>
                                    <NavLink to={"/top-rated"} className="hover:underline">Top Rated</NavLink>
                                </ul>
                            </div>
                            <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400 font-medium">
                                ...
                                <a href="https://instagram.com/zhumashevv_996/" target={"_blank"}
          ...
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a
              href="https://flowbite.com/" className="hover:underline">Eldorado.JM™</a>. All Rights Reserved.
          </span>
                        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                            ...
                            <a href="https://dribbble.com/jumashevv/about" target={"_blank"}
                               className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                    <path fillRule="evenodd"
